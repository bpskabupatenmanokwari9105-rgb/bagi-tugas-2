...
(function($, undefined) {
    ...
    $.fn.gantt = function(options) {
        ...
        var settings = {
            ...
            onRender: function(core, element) {
                return;
            },
            scrollToToday: true
        };
                            ...
                            .append($('<div class="nav-slider-content" />')
                                .append($('<input type="range" class="custom-range nav-slider-range" value="0">')
                                    .on('input change', function() {
                                        core.sliderRange(element, $(this).val())
                                    })
                                )
                        ...
                        $.each(entry.values, function(j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                default:
                                    ...
                                    _bar.css({
                                        'top': top,
                                        'left': typeof cFrom === 'undefined' ? -24 : Math.floor(cFrom)
                                    }); // <-- EDIT
            ...
            navigateTo: function(element, val) {
                ...
                switch (val) {
                    ...
                    default:
                        ...
                        $dataPanel.animate({
                            "margin-left": Math.min(0, Math.max(max_left, val)) + "px"
                        }, "fast", shift);
                        element.scrollNavigation.panelMargin = val;
                        break;
                }
